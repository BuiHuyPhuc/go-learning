...
func (q *Queries) GetUser(ctx context.Context, userID int32) (PreGoAccUserInfo9999, error) {
...
func (q *Queries) GetUsers(ctx context.Context, userID int32) ([]PreGoAccUserInfo9999, error) {
...
func (q *Queries) RemoveUser(ctx context.Context, userID int32) error {
